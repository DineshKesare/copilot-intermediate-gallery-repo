...
- **[APPLICATION_OVERVIEW.md](APPLICATION_OVERVIEW.md)** - Comprehensive guide covering:
  - Detailed application features explanation
  - Complete folder structure with purposes
